...
import CreateMeetCopy from "./Home/CreateMeetCopy";
import CreateMeetNew from "./Home/CreateMeetNew";
import CreateMeetModified from "./Home/CreateMeetModified";
    ...
    <div className="hero-container">
      ...
      <Router>
        <Switch>
          ...
          <Route exact path="/eventCopy/:eventID">
            <CreateMeetCopy />
          </Route>
        </Switch>
      </Router>
      ...
      <Router>
        <Switch>
          <Route exact path="/eventNew/:eventID">
            <CreateMeetNew />
          </Route>
          <Route exact path="/eventModified/:eventID">
            <CreateMeetModified />
          </Route>
        </Switch>
      </Router>
