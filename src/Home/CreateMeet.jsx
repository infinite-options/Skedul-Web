            ...
            .then((data) => {
                ...
                axios
                    ...
                    .then((response) => {
                        ...
                        setSocialId(si);
                        axios
                            .get(BASE_URL + "GetEmailId/" + e)
                            .then((response) => {
                                console.log(response.data);
                                if (
                                    response.data.message ===
                                    "User EmailID doesnt exist"
                                ) {
                ...
                axios
                    ...
                    .then((response) => {
                        let schedule = JSON.parse(
                            response.data.result.result[0].schedule
                        );

                        setSelectedSchedule(schedule);
                        setViewID(
                            response.data.result.result[0].view_unique_id
                        );
            ...
            axios
                ...
                .then((response) => {
                    ...
                    while (appt_start_time < end_time) {
                        ...
                        if (slot_available) {
                            free.push(
                                moment(new Date(appt_start_time * 1000)).format(
                                    "HH:mm:ss"
                                )
                            );
                        }
                        ...
                        {dateRange.hasOwnProperty("Sunday") ? (
                            <Col
                                ...
                                onClick={() => {
                                    ...
                                    setEndTime(
                                        selectedSchedule.Sunday[0].end_time
                                    );
                                }}
                            >
                        ...
                        {dateRange.hasOwnProperty("Monday") ? (
                            <Col
                                ...
                                onClick={() => {
                                    ...
                                    setEndTime(
                                        selectedSchedule.Monday[0].end_time
                                    );
                                }}
                            >
                                Monday, {""}
                        ...
                        {dateRange.hasOwnProperty("Tuesday") ? (
                            <Col
                                ...
                                onClick={() => {
                                    ...
                                    setEndTime(
                                        selectedSchedule.Tuesday[0].end_time
                                    );
                                }}
                            >
                        ...
                        {dateRange.hasOwnProperty("Wednesday") ? (
                            <Col
                                ...
                                onClick={() => {
                                    ...
                                    setEndTime(
                                        selectedSchedule.Wednesday[0].end_time
                                    );
                                }}
                            >
                        ...
                        {dateRange.hasOwnProperty("Thursday") ? (
                            <Col
                                ...
                                onClick={() => {
                                    ...
                                    setEndTime(
                                        selectedSchedule.Thursday[0].end_time
                                    );
                                }}
                            >
                        ...
                        {dateRange.hasOwnProperty("Friday") ? (
                            <Col
                                ...
                                onClick={() => {
                                    ...
                                    setEndTime(
                                        selectedSchedule.Friday[0].end_time
                                    );
                                }}
                            >
                        ...
                        {dateRange.hasOwnProperty("Saturday") ? (
                            <Col
                                ...
                                onClick={() => {
                                    ...
                                    setEndTime(
                                        selectedSchedule.Saturday[0].end_time
                                    );
                                }}
                            >
                    ...
                    <Form.Group className="formEltMargin">
                        ...
                        >
                            <button
                                ...
                                style={{
                                    background:
                                        "#F8BE28 0% 0% no-repeat padding-box",
                                    borderRadius: "20px",
                                    opacity: 1,
                                    width: "300px",
                                }}
                            ...
                            <button
                                ...
                                style={{
                                    marginTop: "10px",
                                    background:
                                        "#FF6B4A 0% 0% no-repeat padding-box",
                                    borderRadius: "20px",
                                    opacity: 1,
                                    width: "300px",
                                }}
        ...
        <div className="container">
            {isLoading ? (
                <Row>
                    ...
                    <Col>
                        <Typography>
                            Sign up for SKEDUL and stay in control
                        </Typography>
                        <button
                            style={{
                                background:
                                ...
                                <Col xs={2}>
                                    ...
                                    >
                                        ...
                                        >
                                            <div>
                                                {Number(
                                                    selectedEvent.duration.substring(
                                                        0,
                                                        2
                                                    )
                                                ) > 1
