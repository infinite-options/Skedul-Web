...
const TimeLine = (props) => {
    ...
    class TimeSlotData {
        ...
        setThirtyMinSize(etarget) {
            this.thirtyMinSize =
                this.direction === "vertical"
                    ? (etarget.parentElement.parentElement.clientHeight - 100) /
                      48
                    : (etarget.parentElement.parentElement.clientWidth - 100) /
                      48;
        }
