    ...
    >
      <Row>
        <Col>
          ...
          >
            <Box marginTop="10%" display="flex" flexDirection="column" display="flex" flexDirection="column" alignItems="center" style={{ width: "25rem" }}>
              <Typography>SIGN UP</Typography>
              <Box display="flex" justifyContent="center" marginTop="1rem">
                <SocialLogin />
              </Box>
              <Box marginTop="1rem" marginBottom="1rem" display="flex" justifyContent="center" style={{ fontWeight: "bold" }}>
              ...
              <Form as={Container}>
                <Form.Group className="formEltMargin">
                  <Form.Group as={Row} className="formEltMargin">
                    <Col>
                      <Form.Control className={classes.textFieldBackgorund} type="text" placeholder="First Name" value={newFName} onChange={handleNewFNameChange} />
                    </Col>
                    <Col>
                      <Form.Control className={classes.textFieldBackgorund} type="text" placeholder="Last Name" value={newLName} onChange={handleNewLNameChange} />
                    </Col>
                  </Form.Group>
                  <Col>
                    <Form.Group as={Row} className="formEltMargin">
                      <Form.Control className={classes.textFieldBackgorund} type="text" placeholder="Email address" value={newEmail} onChange={handleNewEmailChange} />
                    </Form.Group>
                  </Col>
                </Form.Group>
                <Col>
                  <Form.Group as={Row} className="formEltMargin">
                    <Form.Control className={classes.textFieldBackgorund} type="password" placeholder="Create Password" value={newPassword} onChange={handleNewPasswordChange} />
                  </Form.Group>
                </Col>
